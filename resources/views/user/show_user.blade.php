  ...
  <div class="content-wrapper">
    ...
    <div class="alert alert-danger d-flex justify-content-center">{{ session()->get("error") }}</div>
        ...
        <table class="table table-hover">
            ...
            <tbody>
         @foreach($admin2=App\Models\User::paginate(2) as $user)
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <a  href="{{ url("admin/Delete_user/{$user->id}") }}" class="btn btn-danger"><i class=" fa fa-trash"></i></a>
        ...
        <a href="{{ route('add_user') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Add User</a>
        <br/>
        <br/>
