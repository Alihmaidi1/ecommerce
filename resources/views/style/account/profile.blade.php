                                            ...
                                            <ul class="dash__w-list">
                                                <li>
                                                    <div class="dash__w-wrap">
                                                        ...
                                                        <span class="dash__w-name">Orders failed</span></div>
                                                </li>
                                                <li>
                                                    <div class="dash__w-wrap">
                                                        ...
                                                        <span class="dash__w-name">order success</span></div>
                                                </li>
                                                <li>
                                                    <div class="dash__w-wrap">
                                    ...
                                    <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white u-s-m-b-30">
                                        <div class="dash__pad-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    <h2 class="dash__h2 u-s-m-b-8">level</h2>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="u-s-m-b-16">
                                                        ...
                                                        <a class="dash__custom-link btn--e-transparent-brand-b-2" href="/edit_user/{{ auth('web')->user()->id }}">Edit Profile</a></div>
