...
<script src="{{ asset("AdminLTE/jstree/jstree.wholerow.js") }}"></script>
<script src="{{ asset("AdminLTE/jstree/jstree.checkbox.js") }}"></script>
<script src="{{ asset("include/js/map.js") }}"></script>
