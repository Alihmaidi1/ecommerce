...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      <br/>
<form method="POST" action="{{ route("save_mall") }}" enctype="multipart/form-data">
    @csrf
    ...
    <br/>
    <div class="d-flex justify-content-center"><button class="btn btn-primary w-25  ">Create mall</button></div>
</form>
  </div>
